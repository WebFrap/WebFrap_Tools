...
class Fs
{
   ...
   */
  public static function copy( $src, $target, $isFolder = true )
  {
   ...
   * @param boolean $isFolder
   */
  public static function copyContent( $src, $target, $isFolder = true )
  {
   ...
   * @param string $path
   */
  public static function delFileDir( $filename )
  {
   ...
   * @param string $ending
   */
  public static function isA( $fileName, $ending )
  {
   ...
   * @param string $path
   */
  public static function touchFileFolder( $path )
  {
   ...
   * @param string $level
   */
  public static function chmod( $path, $level )
  {
   ...
   */
  public static function setPermission( $perm, $protocol = null )
  {
   ...
   * @param array $values
   */
  public static function template( $targetPath, $tplPath, $values )
  {
